...
const Home = () => {
  return (
  <div className="w-screen h-screen flex items-center justify-center bg-[#0b0013] text-white font-semibold px-4">
  <div className="text-center animate-pulse">
    {/* <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4vw] font-extrabold tracking-wide leading-tight drop-shadow-md">
      <span className="text-red-500">AUTOMAX</span> <span className="text-yellow-300">4.0</span>
    </h1> */}
    <p className="mt-4 text-base sm:text-lg md:text-xl lg:text-[1.5vw] text-gray-300">
      Robotics club is no longer accepting any new registrations.
    </p>
  </div>
</div>
